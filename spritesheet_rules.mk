...
$(OBJEVENTGFXDIR)/people/astrea_gym_leaders/viviane.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4
...
$(OBJEVENTGFXDIR)/people/cassian/walking.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4

$(OBJEVENTGFXDIR)/people/cassian/running.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4
...
$(OBJEVENTGFXDIR)/people/prof_myra.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4
...
$(FLDEFFGFXDIR)/tall_grass_purple.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 2
