...
static const u8 sRivalAvatarGfxIds[][GENDER_COUNT] =
{
    ...
    [PLAYER_AVATAR_STATE_NORMAL]     = {OBJ_EVENT_GFX_RIVAL_BRENDAN_NORMAL,     OBJ_EVENT_GFX_SELENE_NORMAL},
...
static const u8 sPlayerAvatarGfxIds[][GENDER_COUNT] =
{
    ...
    [PLAYER_AVATAR_STATE_NORMAL]     = {OBJ_EVENT_GFX_BRENDAN_NORMAL,     OBJ_EVENT_GFX_SELENE_NORMAL},
...
u8 GetPlayerAvatarGenderByGraphicsId(u16 gfxId)
{
    switch (gfxId)
    {
    case OBJ_EVENT_GFX_SELENE_NORMAL:
