...
static void PrintTitleWindowText(void)
{
    ...
    u32 hoennOffset = GetStringCenterAlignXOffset(FONT_NORMAL, gText_Astrea, 0x38);
    ...
    {
        AddTextPrinterParameterized(WIN_TITLE, FONT_NORMAL, gText_Astrea, hoennOffset, 1, 0, NULL);
