...
static const u8 sTileBitAttributes[NUM_METATILE_BEHAVIORS] =
{
    ...
    [MB_TALL_GRASS_PURPLE]                  = TILE_FLAG_UNUSED | TILE_FLAG_HAS_ENCOUNTERS,
...
{
    if (metatileBehavior == MB_TALL_GRASS || metatileBehavior == MB_LONG_GRASS || metatileBehavior == MB_TALL_GRASS_PURPLE)
        return TRUE;
    else
        return FALSE;
}
...
{
    if (metatileBehavior == MB_TALL_GRASS || metatileBehavior == MB_TALL_GRASS_PURPLE)
        return TRUE;
    else
        return FALSE;
}

bool8 MetatileBehavior_IsTallGrassPurple(u8 metatileBehavior)
{
    if(metatileBehavior == MB_TALL_GRASS_PURPLE)
        return TRUE;
    else
        return FALSE;
}
...
bool8 MetatileBehavior_IsCuttableGrass(u8 metatileBehavior)
{
    if (metatileBehavior == MB_TALL_GRASS
     ...
     || metatileBehavior == MB_TALL_GRASS_PURPLE)
        return TRUE;
    else
        return FALSE;
}
