...
static const u8 sAstreaMapHealLocations[][3] =
{
    [MAPSEC_LUMEN_VILLAGE] = {MAP_GROUP(MAP_LUMEN_VILLAGE), MAP_NUM(MAP_LUMEN_VILLAGE), HEAL_LOCATION_LUMEN_VILLAGE},
    [MAPSEC_SOLSTICE_TOWN] = {MAP_GROUP(MAP_SOLSTICE_TOWN), MAP_NUM(MAP_SOLSTICE_TOWN), HEAL_LOCATION_SOLSTICE_TOWN},
    [MAPSEC_ASTRIDALE] = {MAP_GROUP(MAP_ASTRIDALE), MAP_NUM(MAP_ASTRIDALE), HEAL_LOCATION_ASTRIDALE},
    [MAPSEC_CAELESTIC] = {MAP_GROUP(MAP_CAELESTIC), MAP_NUM(MAP_CAELESTIC), HEAL_LOCATION_CAELESTIC},
    // [MAPSEC_NEBULA_TOWN] = {MAP_GROUP(MAP_NEBULA_TOWN), MAP_NUM(MAP_NEBULA_TOWN), HEAL_LOCATION_NEBULA_TOWN},
    // [MAPSEC_ZENITH_CITY] = {MAP_GROUP(MAP_ZENITH_CITY), MAP_NUM(MAP_ZENITH_CITY), HEAL_LOCATION_ZENITH_CITY},
    // [MAPSEC_DRIFTWOOD_HOLLOW] = {MAP_GROUP(MAP_DRIFTWOOD_HOLLOW), MAP_NUM(MAP_DRIFTWOOD_HOLLOW), HEAL_LOCATION_DRIFTWOOD_HOLLOW},
    // [MAPSEC_STELLARA] = {MAP_GROUP(MAP_STELLARA), MAP_NUM(MAP_STELLARA), HEAL_LOCATION_STELLARA},
    // [MAPSEC_ORIONIS] = {MAP_GROUP(MAP_ORIONIS), MAP_NUM(MAP_ORIONIS), HEAL_LOCATION_ORIONIS},
    // [MAPSEC_MYRREN_TOWN] = {MAP_GROUP(MAP_MYRREN_TOWN), MAP_NUM(MAP_MYRREN_TOWN), HEAL_LOCATION_MYRREN_TOWN},
    // [MAPSEC_ASTRALIS_PEAK] = {MAP_GROUP(MAP_ASTRALIS_PEAK), MAP_NUM(MAP_ASTRALIS_PEAK), HEAL_LOCATION_ASTRALIS_PEAK},
    [MAPSEC_ROUTE_1_STARLIT_PATH] = {MAP_GROUP(MAP_ROUTE1_STARLIT_PATH), MAP_NUM(MAP_ROUTE1_STARLIT_PATH), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_2_SUNFADE_TRAIL] = {MAP_GROUP(MAP_ROUTE2_SUNFADE_TRAIL), MAP_NUM(MAP_ROUTE2_SUNFADE_TRAIL), HEAL_LOCATION_NONE},
    [MAPSEC_ROUTE_3_ECHO_RIDGE] = {MAP_GROUP(MAP_ROUTE3_ECHO_RIDGE), MAP_NUM(MAP_ROUTE3_ECHO_RIDGE), HEAL_LOCATION_NONE},
    // [MAPSEC_ROUTE_4_CELESTINE_WAY] = {MAP_GROUP(MAP_ROUTE_4_CELESTINE_WAY), MAP_NUM(MAP_ROUTE_4_CELESTINE_WAY), HEAL_LOCATION_NONE},
    // [MAPSEC_ROUTE_5_ASTRAL_GLADE] = {MAP_GROUP(MAP_ROUTE_5_ASTRAL_GLADE), MAP_NUM(MAP_ROUTE_5_ASTRAL_GLADE), HEAL_LOCATION_NONE},
    // [MAPSEC_ROUTE_6_REVERIE_LANE] = {MAP_GROUP(MAP_ROUTE_6_REVERIE_LANE), MAP_NUM(MAP_ROUTE_6_REVERIE_LANE), HEAL_LOCATION_NONE},
    // [MAPSEC_ROUTE_7_COMETS_PATH] = {MAP_GROUP(MAP_ROUTE_7_COMETS_PATH), MAP_NUM(MAP_ROUTE_7_COMETS_PATH), HEAL_LOCATION_NONE},
    // [MAPSEC_ROUTE_8_MOONVEIL_PASS] = {MAP_GROUP(MAP_ROUTE_8_MOONVEIL_PASS), MAP_NUM(MAP_ROUTE_8_MOONVEIL_PASS), HEAL_LOCATION_NONE},
    // [MAPSEC_ROUTE_9_IRONRAIL_BRIDGE] = {MAP_GROUP(MAP_ROUTE_9_IRONRAIL_BRIDGE), MAP_NUM(MAP_ROUTE_9_IRONRAIL_BRIDGE), HEAL_LOCATION_NONE},
    // [MAPSEC_ROUTE_10_STARFORGE_VALLEY] = {MAP_GROUP(MAP_ROUTE_10_STARFORGE_VALLEY), MAP_NUM(MAP_ROUTE_10_STARFORGE_VALLEY), HEAL_LOCATION_NONE},
    // [MAPSEC_ROUTE_11_RADIANT_VERGE] = {MAP_GROUP(MAP_ROUTE_11_RADIANT_VERGE), MAP_NUM(MAP_ROUTE_11_RADIANT_VERGE), HEAL_LOCATION_NONE},
    // [MAPSEC_ROUTE_12_MIRAGE_BAY] = {MAP_GROUP(MAP_ROUTE_12_MIRAGE_BAY), MAP_NUM(MAP_ROUTE_12_MIRAGE_BAY), HEAL_LOCATION_NONE},
    // [MAPSEC_ROUTE_13_TIDEGLASS_STRAIT] = {MAP_GROUP(MAP_ROUTE_13_TIDEGLASS_STRAIT), MAP_NUM(MAP_ROUTE_13_TIDEGLASS_STRAIT), HEAL_LOCATION_NONE},
    // [MAPSEC_ROUTE_14_STARSEA_PASSAGE] = {MAP_GROUP(MAP_ROUTE_14_STARSEA_PASSAGE), MAP_NUM(MAP_ROUTE_14_STARSEA_PASSAGE), HEAL_LOCATION_NONE},
    // [MAPSEC_ROUTE_15_FROSTFALL_RISE] = {MAP_GROUP(MAP_ROUTE_15_FROSTFALL_RISE), MAP_NUM(MAP_ROUTE_15_FROSTFALL_RISE), HEAL_LOCATION_NONE},
    // [MAPSEC_ROUTE_16_SNOWFALL_PATH] = {MAP_GROUP(MAP_ROUTE_16_SNOWFALL_PATH), MAP_NUM(MAP_ROUTE_16_SNOWFALL_PATH), HEAL_LOCATION_NONE},
};

// static const u16 sAstreaFlyableMapSecIds[FLYABLE_MAPSEC_COUNT] =
// {
//     MAPSEC_LUMEN_VILLAGE,
//     MAPSEC_SOLSTICE_TOWN,
//     MAPSEC_ASTRIDALE,
//     MAPSEC_CAELESTIC,
//     MAPSEC_NEBULA_TOWN,
//     MAPSEC_ZENITH_CITY,
//     MAPSEC_DRIFTWOOD_HOLLOW,
//     MAPSEC_STELLARA,
//     MAPSEC_ORIONIS,
//     MAPSEC_MYRREN_TOWN,
//     MAPSEC_ASTRALIS_PEAK
// };
...
static u8 GetMapsecType(u16 mapSecId)
{
    ...
    case MAPSEC_LUMEN_VILLAGE:
        return FlagGet(FLAG_VISITED_LUMEN_VILLAGE) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_SOLSTICE_TOWN:
        return FlagGet(FLAG_VISITED_SOLSTICE_TOWN) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_ASTRIDALE:
        return FlagGet(FLAG_VISITED_ASTRIDALE) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_CAELESTIC:
        return FlagGet(FLAG_VISITED_CAELESTIC) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_NEBULA_TOWN:
        return FlagGet(FLAG_VISITED_NEBULA_TOWN) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_ZENITH_CITY:
        return FlagGet(FLAG_VISITED_ZENITH_CITY) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_DRIFTWOOD_HOLLOW:
        return FlagGet(FLAG_VISITED_DRIFTWOOD_HOLLOW) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_STELLARA:
        return FlagGet(FLAG_VISITED_STELLARA) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_ORIONIS:
        return FlagGet(FLAG_VISITED_ORIONIS) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_MYRREN_TOWN:
        return FlagGet(FLAG_VISITED_MYRREN_TOWN) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_ASTRALIS_PEAK:
        return FlagGet(FLAG_VISITED_ASTRALIS_PEAK) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
...
static void CreateFlyDestIcons(void)
{
    ...
    canFlyFlag = FLAG_VISITED_LUMEN_VILLAGE;
    for (mapSecId = MAPSEC_LUMEN_VILLAGE; mapSecId <= MAPSEC_ASTRALIS_PEAK; mapSecId++)
    {
...
u32 FilterFlyDestination(struct RegionMap* regionMap)
{
    ...
    default:
        if (sAstreaMapHealLocations[regionMap->mapSecId][2] != HEAL_LOCATION_NONE)
            return sAstreaMapHealLocations[regionMap->mapSecId][2];
        else
            return WARP_ID_NONE;
    }
}
...
void SetFlyDestination(struct RegionMap* regionMap)
{
    ...
    if (flyDestination != WARP_ID_NONE)
        ...
        SetWarpDestinationToMapWarp(sAstreaMapHealLocations[regionMap->mapSecId][0], sAstreaMapHealLocations[regionMap->mapSecId][1], WARP_ID_NONE);
}
