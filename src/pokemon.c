...
#define ASTREA_TO_NATIONAL(name)     [ASTREA_DEX_##name - 1] = NATIONAL_DEX_##name

// Assigns all Astrea Dex Indexes to a National Dex Index
static const u16 sAstreaToNationalOrder[ASTREA_DEX_COUNT - 1] =
{
    ASTREA_TO_NATIONAL(SQUIRTLE),
    ASTREA_TO_NATIONAL(WARTORTLE),
    ASTREA_TO_NATIONAL(BLASTOISE),
    ASTREA_TO_NATIONAL(FENNEKIN),
    ASTREA_TO_NATIONAL(BRAIXEN),
    ASTREA_TO_NATIONAL(DELPHOX),
    ASTREA_TO_NATIONAL(SPRIGATITO),
    ASTREA_TO_NATIONAL(FLORAGATO),
    ASTREA_TO_NATIONAL(MEOWSCARADA),
    ASTREA_TO_NATIONAL(PIDGEY),
    ASTREA_TO_NATIONAL(PIDGEOTTO),
    ASTREA_TO_NATIONAL(PIDGEOT),
    ASTREA_TO_NATIONAL(RATTATA),
    ASTREA_TO_NATIONAL(RATICATE),
    ASTREA_TO_NATIONAL(CATERPIE),
    ASTREA_TO_NATIONAL(METAPOD),
    ASTREA_TO_NATIONAL(BUTTERFREE),
    ASTREA_TO_NATIONAL(WEEDLE),
    ASTREA_TO_NATIONAL(KAKUNA),
    ASTREA_TO_NATIONAL(BEEDRILL),
    ASTREA_TO_NATIONAL(BUNNELBY),
    ASTREA_TO_NATIONAL(DIGGERSBY),
    ASTREA_TO_NATIONAL(FLETCHLING),
    ASTREA_TO_NATIONAL(FLETCHINDER),
    ASTREA_TO_NATIONAL(TALONFLAME),
    ASTREA_TO_NATIONAL(BIDOOF),
    ASTREA_TO_NATIONAL(BIBAREL),
    ASTREA_TO_NATIONAL(PAWMI),
    ASTREA_TO_NATIONAL(PAWMO),
    ASTREA_TO_NATIONAL(PAWMOT),
    ASTREA_TO_NATIONAL(HOOTHOOT),
    ASTREA_TO_NATIONAL(NOCTOWL),
    ASTREA_TO_NATIONAL(SPINARAK),
    ASTREA_TO_NATIONAL(ARIADOS),
    ASTREA_TO_NATIONAL(SEEDOT),
    ASTREA_TO_NATIONAL(NUZLEAF),
    ASTREA_TO_NATIONAL(SHIFTRY),
    ASTREA_TO_NATIONAL(SEWADDLE),
    ASTREA_TO_NATIONAL(SWADLOON),
    ASTREA_TO_NATIONAL(LEAVANNY),
    ASTREA_TO_NATIONAL(MORELULL),
    ASTREA_TO_NATIONAL(SHIINOTIC),
    ASTREA_TO_NATIONAL(FOMANTIS),
    ASTREA_TO_NATIONAL(LURANTIS),
    ASTREA_TO_NATIONAL(BUDEW),
    ASTREA_TO_NATIONAL(ROSELIA),
    ASTREA_TO_NATIONAL(ROSERADE),
    ASTREA_TO_NATIONAL(BULBASAUR),
    ASTREA_TO_NATIONAL(IVYSAUR),
    ASTREA_TO_NATIONAL(VENUSAUR),
    ASTREA_TO_NATIONAL(CLEFFA),
    ASTREA_TO_NATIONAL(CLEFAIRY),
    ASTREA_TO_NATIONAL(CLEFABLE),
    ASTREA_TO_NATIONAL(RALTS),
    ASTREA_TO_NATIONAL(KIRLIA),
    ASTREA_TO_NATIONAL(GARDEVOIR),
    ASTREA_TO_NATIONAL(GALLADE),
    ASTREA_TO_NATIONAL(FLABEBE),
    ASTREA_TO_NATIONAL(FLOETTE),
    ASTREA_TO_NATIONAL(FLORGES),
    ASTREA_TO_NATIONAL(CUTIEFLY),
    ASTREA_TO_NATIONAL(RIBOMBEE),
    ASTREA_TO_NATIONAL(TINKATINK),
    ASTREA_TO_NATIONAL(TINKATUFF),
    ASTREA_TO_NATIONAL(TINKATON),
    ASTREA_TO_NATIONAL(ROCKRUFF),
    ASTREA_TO_NATIONAL(LYCANROC),
    ASTREA_TO_NATIONAL(GEODUDE),
    ASTREA_TO_NATIONAL(GRAVELER),
    ASTREA_TO_NATIONAL(GOLEM),
    ASTREA_TO_NATIONAL(NICKIT),
    ASTREA_TO_NATIONAL(THIEVUL),
    ASTREA_TO_NATIONAL(NACLI),
    ASTREA_TO_NATIONAL(NACLSTACK),
    ASTREA_TO_NATIONAL(GARGANACL),
    ASTREA_TO_NATIONAL(SANDYGAST),
    ASTREA_TO_NATIONAL(PALOSSAND),
    ASTREA_TO_NATIONAL(DROWZEE),
    ASTREA_TO_NATIONAL(HYPNO),
    ASTREA_TO_NATIONAL(MUNNA),
    ASTREA_TO_NATIONAL(MUSHARNA),
};
...
enum AstreaDexOrder NationalToAstreaOrder(enum NationalDexOrder nationalNum)
{
    ...
    while (astreaNum < (ASTREA_DEX_COUNT - 1) && sAstreaToNationalOrder[astreaNum] != nationalNum)
        astreaNum++;

    if (astreaNum >= ASTREA_DEX_COUNT - 1)
        return 0;
...
enum NationalDexOrder AstreaToNationalOrder(enum AstreaDexOrder astreaNum)
{
    ...
    return sAstreaToNationalOrder[astreaNum - 1];
}
...
u16 PlayerGenderToFrontTrainerPicId(u8 playerGender)
{
    if (playerGender != MALE)
        ...
        return FacilityClassToPicIndex(FACILITY_CLASS_CASSIAN);
}
