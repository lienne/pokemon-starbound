...
const u16 gFieldEffectObjectPalette_PurpleGrass[] = INCBIN_U16("graphics/field_effects/palettes/tall_grass_purple.gbapal");
...
const u32 gFieldEffectObjectPic_TallGrass_Purple[] = INCBIN_U32("graphics/field_effects/pics/tall_grass_purple.4bpp");
