...
static const struct SpriteFrameImage sPicTable_ProfMyra[] = {
    overworld_ascending_frames(gObjectEventPic_ProfMyra, 2, 4),
};
...
static const struct SpriteFrameImage sPicTable_CassianNormal[] = {
    overworld_ascending_frames(gObjectEventPic_CassianNormalRunning, 2, 4),
};
...
// Astrea Gym Leaders
static const struct SpriteFrameImage sPicTable_Viviane[] = {
    overworld_ascending_frames(gObjectEventPic_Viviane, 2, 4),
};
