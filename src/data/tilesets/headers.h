...
const struct Tileset gTileset_AstridaleMindscape =
{
    .isCompressed = TRUE,
    .isSecondary = FALSE,
    .tiles = gTilesetTiles_AstridaleMindscape,
    .palettes = gTilesetPalettes_AstridaleMindscape,
    .metatiles = gMetatiles_AstridaleMindscape,
...
const struct Tileset gTileset_New_Petalburg =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_New_Petalburg,
    ...
    .callback = InitTilesetAnim_New_Petalburg,
};
...
const struct Tileset gTileset_Caelestic =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_Caelestic,
