...
const struct TrainerBacksprite gTrainerBacksprites[] =
{
    ...
    TRAINER_BACK_SPRITE(TRAINER_BACK_PIC_SELENE, 4, gTrainerBackPic_Selene, gTrainerBackPicPalette_Selene, sBackAnims_Kanto),
    TRAINER_BACK_SPRITE(TRAINER_BACK_PIC_CASSIAN, 4, gTrainerBackPic_Cassian, gTrainerBackPicPalette_Cassian, sBackAnims_Kanto),
