...
const u8 gText_ExpandedPlaceholder_Cassian[] = _("Cassian");
...
const u8 gText_DexAstreaTitle[] = _("Astrea Dex");
...
const u8 gText_DexAstreaDescription[] = _("Astrea region's Pokédex");
...
const u8 gText_BirchInTrouble[] = _("Jirachi is in trouble!\nRelease a Pokémon and rescue it!");
...
const u8 gText_FollowerFainted[] = _("Camnnot set a fainted Pokémon as\nyour preferred follower! {PAUSE_UNTIL_PRESS}");
...
const u8 gText_ExpertTagMatch[] = _("Epert Tag Match");
...
const u8 gText_DexAstrea[] = _("Astrea");
...
const u8 gText_Astrea[] = _("Astrea");
...
const u8 gText_SideQuestMap2[] = _("Starfall Clearing");
