...
enum {
    ASTREA_DEX_NONE,
    ASTREA_DEX_SQUIRTLE,
    ASTREA_DEX_WARTORTLE,
    ASTREA_DEX_BLASTOISE,
    ASTREA_DEX_SPRIGATITO,
    ASTREA_DEX_FLORAGATO,
    ASTREA_DEX_MEOWSCARADA,
    ASTREA_DEX_FENNEKIN,
    ASTREA_DEX_BRAIXEN,
    ASTREA_DEX_DELPHOX,
    ASTREA_DEX_PIDGEY,
    ASTREA_DEX_PIDGEOTTO,
    ASTREA_DEX_PIDGEOT,
    ASTREA_DEX_RATTATA,
    ASTREA_DEX_RATICATE,
    ASTREA_DEX_CATERPIE,
    ASTREA_DEX_METAPOD,
    ASTREA_DEX_BUTTERFREE,
    ASTREA_DEX_WEEDLE,
    ASTREA_DEX_KAKUNA,
    ASTREA_DEX_BEEDRILL,
    ASTREA_DEX_BUNNELBY,
    ASTREA_DEX_DIGGERSBY,
    ASTREA_DEX_FLETCHLING,
    ASTREA_DEX_FLETCHINDER,
    ASTREA_DEX_TALONFLAME,
    ASTREA_DEX_BIDOOF,
    ASTREA_DEX_BIBAREL,
    ASTREA_DEX_PAWMI,
    ASTREA_DEX_PAWMO,
    ...
    ASTREA_DEX_LEAVANNY,
    ASTREA_DEX_MORELULL,
    ASTREA_DEX_SHIINOTIC,
    ASTREA_DEX_FOMANTIS,
    ASTREA_DEX_LURANTIS,
    ASTREA_DEX_BUDEW,
    ASTREA_DEX_ROSELIA,
    ASTREA_DEX_ROSERADE,
    ASTREA_DEX_BULBASAUR,
    ASTREA_DEX_IVYSAUR,
    ASTREA_DEX_VENUSAUR,
    ASTREA_DEX_CLEFFA,
    ASTREA_DEX_CLEFAIRY,
    ...
    ASTREA_DEX_CUTIEFLY,
    ASTREA_DEX_RIBOMBEE,
    ASTREA_DEX_TINKATINK,
    ASTREA_DEX_TINKATUFF,
    ASTREA_DEX_TINKATON,
    ASTREA_DEX_ROCKRUFF,
    ASTREA_DEX_LYCANROC,
    ASTREA_DEX_GEODUDE,
    ...
    ASTREA_DEX_THIEVUL,
    ASTREA_DEX_NACLI,
    ASTREA_DEX_NACLSTACK,
    ASTREA_DEX_GARGANACL,
    ASTREA_DEX_SANDYGAST,
    ASTREA_DEX_PALOSSAND,
    ASTREA_DEX_DROWZEE,
    ASTREA_DEX_HYPNO,
    ASTREA_DEX_MUNNA,
    ASTREA_DEX_MUSHARNA,
...
#define ASTREA_DEX_COUNT (ASTREA_DEX_MUSHARNA + 1)
