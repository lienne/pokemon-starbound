...
enum {
    ...
    HEAL_LOCATION_LUMEN_VILLAGE,
    HEAL_LOCATION_BEGINNER_CLEARING,
    HEAL_LOCATION_SOLSTICE_TOWN,
    HEAL_LOCATION_ASTRIDALE,
    HEAL_LOCATION_ASTRIDALE_MINDSCAPE,
    HEAL_LOCATION_ASTRIDALE_2,
    NUM_HEAL_LOCATIONS
};
