...
#define OBJ_EVENT_GFX_SELENE_NORMAL              243
#define OBJ_EVENT_GFX_PROF_MYRA                  244
#define OBJ_EVENT_GFX_VIVIANE                    245
#define OBJ_EVENT_GFX_CASSIAN_NORMAL             246
...
#define OBJ_EVENT_GFX_ZIGZAGOON OBJ_EVENT_GFX_SPECIES(ZIGZAGOON)
#define OBJ_EVENT_GFX_MACHOKE OBJ_EVENT_GFX_SPECIES(MACHOKE)
#define OBJ_EVENT_GFX_MUNNA OBJ_EVENT_GFX_SPECIES(MUNNA)
#define OBJ_EVENT_GFX_SCYTHER OBJ_EVENT_GFX_SPECIES(SCYTHER)
